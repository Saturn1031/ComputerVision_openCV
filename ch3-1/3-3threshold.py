...
ret, img_binaryB = cv2.threshold(gray, 128, 255, cv2.THRESH_BINARY)
cv2.putText(img_binaryB,"BINARY",(20,30),cv2.FONT_HERSHEY_PLAIN,1.5, 255, 2)
ret, img_binaryBINV = cv2.threshold(gray, 128, 255, cv2.THRESH_BINARY_INV)
cv2.putText(img_binaryBINV,"BINARY_INV",(20,30),cv2.FONT_HERSHEY_PLAIN,1.5, 0, 2)
ret, img_binaryT = cv2.threshold(gray, 128, 255, cv2.THRESH_TRUNC)
cv2.putText(img_binaryT,"TRUNC",(20,30),cv2.FONT_HERSHEY_PLAIN,1.5, 0, 2)
ret, img_binaryT0 = cv2.threshold(gray, 128, 255, cv2.THRESH_TOZERO)
cv2.putText(img_binaryT0,"TOZERO",(20,30),cv2.FONT_HERSHEY_PLAIN,1.5, 255, 2)
ret, img_binaryT0INV = cv2.threshold(gray, 128, 255, cv2.THRESH_TOZERO_INV)
